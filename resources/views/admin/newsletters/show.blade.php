                ...
                <div class="col-md-12">
                    <div class="w-auto p-3">
                        <div class="panel-heading-admin">
                            <h5>Edição nº: <strong>{{$newsletter->numb_edicao}}</strong> - {{ \Carbon\Carbon::parse($newsletter->data_edicao)->format('d/m/Y') }}</h5>
                        </div>
                            ...
                            <div class="row news btn-new-reset">
                                ...
                                <div class="col-4">
                                    ...
                                    <?php $formDelete = FormBuilder::plain([
                                        'id' => 'form-delete',
                                        'route' => ['admin.newsletters.destroy', 'newsletter' => $newsletter->id],
                                        'method' => 'DELETE',
                                        'style' => 'display:none',
                                        ]); ?>
                                    {!! form($formDelete) !!}

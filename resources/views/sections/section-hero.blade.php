            ...
            <div class="col-12 hero-text-image">
                <div class="row">
                    <div class="col-lg-5 text-center text-lg-start">
                        <h1 data-aos-delay="300">Informação sem tempo a perder</h1>
                        ...
                        <p>Das últimas de Brasília ao vai e vem dos mercados, das apostas das big techs
                            aos lançamentos dos cinemas e streamings - o que importa está lá, em <strong class="minutos"> 7 minutos</strong> ou menos de leitura.</p>
                        ...
                        <div class="btn-hero">
                            <p data-aos-delay="500"><a href="{{route('clientes.index')}}" class="btn btn-assinar">ASSINE</a></p>
                        </div>
                    ...
                    <div class="col-7 d-flex justify-content-center">
                        <div class="col-lg-7 iphone-wrap">
                            <img src="{{asset('site/img/hero5.png')}}" alt="Image" class="phone-1" data-aos-delay="300">
                        </div>
                    </div>
                </div>
            </div>

            ...
            <div class="col-12 hero-text-image">
                <div class="row">
                    <div class="col-lg-5 text-center text-lg-start">
                        <h1 data-aos="zoom-in">Informação sem tempo a perder</h1>
                        ...
                        <div class="btn-hero">
                            <p data-aos="zoom-out" data-aos-delay="100"><a href="{{route('clientes.index')}}" class="btn btn-assinar">ASSINE</a></p>
                        </div>
